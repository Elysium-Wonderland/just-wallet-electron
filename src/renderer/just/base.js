...
let Just = function (url, chainId) {
    this.url = url;
    this.chainId = chainId;
    this.path = "m/44'/521'/0'/0/0";
    this.bech32MainPrefix = "jt";
...
Just.prototype.setBech32MainPrefix = function (bech32MainPrefix) {
...
Just.prototype.setPath = function (path) {
    this.path = path;
...
Just.prototype.getAccounts = function (address) {
    return fetch(this.url + "/auth/accounts/" + address)
        .then(response => response.json()
        )
};

Just.prototype.getAddress = function (mnemonic) {
...
Just.prototype.getECPairPriv = function (mnemonic) {
    if (typeof mnemonic !== "string") {
        throw new Error("mnemonic expects a string")
    }
    const seed = bip39.mnemonicToSeed(mnemonic);
...
Just.prototype.NewStdMsg = function (input) {
...
Just.prototype.sign = function (stdSignMsg, ecpairPriv, modeType = "sync") {
...
Just.prototype.broadcast = function (signedTx) {
